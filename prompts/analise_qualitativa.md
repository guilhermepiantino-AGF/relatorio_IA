...
- Evite jargão vazio ("empresa sólida", "bem posicionada no mercado")
- Se usar informação setorial ou de concorrentes que não está nos dados,
  deixe claro que é análise externa baseada em conhecimento geral do setor
- Não invente fatos específicos (nomes de executivos, aquisições, parcerias)
